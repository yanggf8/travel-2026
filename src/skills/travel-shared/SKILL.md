...
- **CRITICAL**: All mutations via StateManager/CLI — see `references/db-first-pattern.md` (never edit JSON directly)
...
- `references/db-first-pattern.md` — **READ FIRST** — Why direct JSON edits break the system
