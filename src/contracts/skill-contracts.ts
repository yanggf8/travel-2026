...
export const SKILL_CONTRACTS: Record<string, SkillContract> = {
  ...
  'update-offer': {
    ...
    output: { type: 'void', description: 'Updates Turso DB (plan_offers, event_log_*)' },
    mutates: [
      'plan_offers',
      'event_log_dest_processes',
    ],
    data_freshness: 'cached',
  ...
  'init-project': {
    ...
    output: { type: 'object', description: '{ planId }' },
    mutates: ['plans', 'plan_destinations', 'date_anchors', 'process_statuses'],
    data_freshness: 'static',
